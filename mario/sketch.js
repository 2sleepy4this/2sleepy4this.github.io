...
const COLLIDABLES = [TILE_BRICK, JUMP_BLOCK, JUMP_BLOCK_HIT, MUSHROOM_TOP, PLAYER, CLOUD_LEFT, CLOUD_RIGHT]
...
function checkGameOver() {
    ...
    if (lives == 0) {
        ...
        fill(255, 0, 0)
        textAlign(CENTER)
        text("You collected all the coins! ◝(ᵔᵕᵔ)◜", width/4 + viewX, height/4 + viewY)
        text("Click to Restart", width/4 + viewX, height/4 + 20 + viewY)
        gameOver = true
        noLoop()
    }
